            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <h3 class="d-inline-block d-sm-none">{{ $project->title }}</h3>
                        <div class="col-12 mb-2">
                            <img src="{{ asset('public/' . $project->image) }}" class="product-image main-image" alt="صورة الغلاف">
                        </div>
                        <div class="col-12 d-flex flex-wrap product-image-thumbs">
                            <div class="product-image-thumb active" data-image="{{ asset('public/' . $project->image) }}">
                                <img src="{{ asset('public/' . $project->image) }}" alt="صورة الغلاف">
                            </div>
