        ...
        <div class="row">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="{{ asset('public/' . $admin->photo) }}"
                        ...
                        <form action="{{ route('cv.upload') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <label for="cv">اختر ملف الـ CV (PDF, DOC, DOCX):</label>
            ...
            <div class="col-md-9">
                    ...
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#settings"
                                                    data-toggle="tab">البيانات</a>
                            </li>
                            <li class="nav-item"><a class="nav-link " href="#links" data-toggle="tab">الروابط</a></li>
                            <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">المهارات</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="settings">
                                ...
                                <form action="{{ route('admin.profile.update') }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control"
                                                   value="{{ old('name', $admin->name) }}" placeholder="الاسم">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="password" class="col-sm-2 col-form-label">كلمة المرور
                                            (اختياري)</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="title" class="col-sm-2 col-form-label">الشرح المختصر</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control"
                                                   value="{{ old('title', $admin->title) }}" placeholder="شرح مختصر">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="phone" class="form-control"
                                                   value="{{ old('phone', $admin->phone) }}" placeholder="رقم الهاتف">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="location" class="form-control"
                                                   value="{{ old('location', $admin->location) }}" placeholder="موقعك">
                                        </div>
                                    </div>
                ...
                <textarea name="description" class="form-control" rows="4"
                          placeholder="الوصف">{{ old('description', $admin->description) }}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group row w-75 mr-auto">
                                        <label for="description" class="col-sm-2 col-form-label">الصورة</label>
                                        <input type="file" name="photo" class="form-control-file " id="projectImage"
                                               multiple>
                                    </div>
                                ...
                                <form action="{{ route('admin.social-links.update') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="telegram" id="telegram" class="form-control"
                                               value="{{ old('telegram', $social->telegram) }}"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($skills as $skill)
                                        <tr>
                                            ...
                                            <td>
                                                <!-- تفعيل / الغاء -->
                                                <form action="{{ route('skills.toggle', $skill) }}" method="POST"
                                        ...
                                        <div class="modal fade" id="editSkillModal{{ $skill->id }}" tabindex="-1"
                                             role="dialog" aria-labelledby="editSkillModalLabel{{ $skill->id }}"
                                             aria-hidden="true">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name"
                                                                       value="{{ $skill->name }}" class="form-control"
                                                                       required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>المستوى (%)</label>
